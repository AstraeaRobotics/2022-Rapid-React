...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public ClimberSubsystem() {
    ...
    m_elevatorSimulation = new ElevatorSim(DCMotor.getNEO(1), 100, 45,
        Units.inchesToMeters(2), 0, 1);
    ...
    m_elevatorMech2d = m_mech2dRoot.append(new MechanismLigament2d("Elevator",
        Units.metersToInches(m_elevatorSimulation.getPositionMeters()), 90));
  ...
  public void periodic() {
    // setSpeed(0.2);
    SmartDashboard.putNumber("Elevator Sim Position",
  ...
  public void climb() {
    setSpeed(Climber.kElevatorSpeed);
  }
  ...
  public void log() {
    SmartDashboard.putNumber("Current Position",
        Double.valueOf(String.valueOf(m_climberMotor.getEncoder())));
  }

  @Override
  public void simulationPeriodic() {
    m_elevatorSimulation
        .setInput(m_climberMotor.get() * RobotController.getBatteryVoltage());
    m_elevatorSimulation.update(0.020);
    m_encoderSimulation.setDistance(m_elevatorSimulation.getPositionMeters());
    m_elevatorMech2d.setLength(
        Units.metersToInches(m_elevatorSimulation.getPositionMeters()));
