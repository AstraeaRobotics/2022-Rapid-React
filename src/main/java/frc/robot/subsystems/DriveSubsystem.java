...
public class DriveSubsystem extends SubsystemBase {
  ...
  public CANSparkMax[] getMotors() {
    return new CANSparkMax[] {
      m_leftMotor1, m_leftMotor2, m_leftMotor3, m_rightMotor1, m_rightMotor2, m_rightMotor3
    };
  }
  ...
  public void tankDrive(double speed) {
    m_drive.tankDrive(
        speed * Constants.DriveConstants.kTurnSpeed, speed * Constants.DriveConstants.kTurnSpeed);
  }

  /**
   * Controls each side of the robot individually. This method does not scale input values and
   * passes them directly into the drive controller
   *
   * @param left The speed of the left side of the robot
   * @param right The speed of the right side of the robot
   */
  ...
  public void curveDrive(double xSpeed, double rotation, boolean turn) {
    m_drive.curvatureDrive(
        xSpeed * DriveConstants.kDriveSpeed, rotation * DriveConstants.kTurnSpeed, turn);
  }

  public void arcadeDrive(double xSpeed, double rotation, boolean stabilize) {
    m_drive.arcadeDrive(
        xSpeed * DriveConstants.kDriveSpeed, rotation * DriveConstants.kTurnSpeed, stabilize);
  }
  ...
  public void simulationPeriodic() {
    ...
    int leftHandle =
        SimDeviceDataJNI.getSimDeviceHandle("SPARK MAX [" + m_leftMotor1.getDeviceId() + "]");
    int rightHandle =
        SimDeviceDataJNI.getSimDeviceHandle("SPARK MAX [" + m_rightMotor1.getDeviceId() + "]");
   ...
   *
   * <p>NOTE: This method also resets encoders.
   *
