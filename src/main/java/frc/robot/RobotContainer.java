...
public class RobotContainer {
  ...
  // private static final JoystickButton m_crossButton = new JoystickButton(driverGamepad,
  ...
  public Command getAutonomousCommand() {
    ...
    return new TwoBall(m_driveSubsystem, m_intakeSubsystem, m_indexerSubsystem);
  }
}
